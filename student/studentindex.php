...
<body>
    ...
    <header>
        ...
        <nav>
            <a class="nav-link" href="studentindex.php" style="border-bottom: 2px solid #4a4a4a;"><i class="fa-solid fa-house"></i> Home &nbsp;</a>
    ...
    <section>
        <ul>
            ...
            <li>Profile</li>
                <ul>
                    <li>This page displays about student information.</li>
                </ul>
            <li>Task</li>
                <ul>
                    <li>This page lets students to submit their task</li>
                </ul>
            <li>Outputs</li>
                <ul>
                    <li>This page lets students to submit their task</li>
